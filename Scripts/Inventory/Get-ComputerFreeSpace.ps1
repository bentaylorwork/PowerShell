    ...
    Begin {
        ...
        forEach ($computer in $computerName) {
            try {
                ...
                Write-Verbose "INFO: $computer - Trying to Get Disk Space"
                if($Protocol -eq 'Auto') {
                    Try {
                ...
                Write-Verbose "INFO: $computer - Successfully queried Disk space Info"

                if($disks) {
                    Write-Verbose "INFO: $computer - Disk info found"
                    forEach ($disk in $disks) {
                        ...
                        $returnArray.Add($returnObj) | Out-Null                     
                    }
                }
            } Catch {
                Write-Error "ERROR: $computer - Could not query disk space info."
            } finally {
